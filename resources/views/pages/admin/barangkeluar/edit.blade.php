<x-app-layout title="barangkeluar">
    <div class="page-body">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">form class="theme-form mega-form"
                                    <form class="theme-form mega-form" id="form_input" method="POST"
                                        action="{{ route('admin.barangkeluar.update', $barangKeluar->id) }}"
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="kode_barang"
                                                        value="{{ $barangKeluar->kode_barang }}" class="form-control"
                                                        placeholder="Masukkan Kode Barang">
                                                </div>
                                                <div class="mb-3">
                                                    <label class="form-label">Jumlah Barang</label>
                                                    <input type="number" name="quantity"
                                                        value="{{ $barangKeluar->quantity }}" class="form-control"
                                                        placeholder="Masukkan Jumlah Barang">
                                                </div>
                                                <div class="mb-3">
                                                    <label class="form-label">Tujuan</label>
                                                    <input type="text" name="destination"
                                                        value="{{ $barangKeluar->destination }}" class="form-control"
                                                ...
                                                {{-- <div class="mb-3">
                                                    ...
                                                    <img src="{{ asset('images/barangkeluar/' . $barangKeluar->cover) }}"
                                                        alt="Cover" width="100">
                                                </div> --}}
                                            </div>

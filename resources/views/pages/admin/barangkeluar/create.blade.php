<x-app-layout title="Data Produk">
    ...
    <form id="form_input" method="POST" action="{{ route('admin.barangkeluar.store') }}" enctype="multipart/form-data">
        @csrf
        <div class="card">
            <div class="card-body">
                <div class="mb-3">
            ...
            <div class="card-footer">
                <button class="btn btn-primary" type="submit">Tambah Barang Keluar</button>
            </div>
        </div>
    </form>
    @section('custom_js')
